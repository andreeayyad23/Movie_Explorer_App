...
class DescribeModel {
  ...
  factory DescribeModel.fromRawJson(String str) =>
      DescribeModel.fromJson(json.decode(str));

  String toRawJson() => json.encode(toJson());

  factory DescribeModel.fromJson(Map<String, dynamic> json) => DescribeModel(
        adult: json["adult"],
